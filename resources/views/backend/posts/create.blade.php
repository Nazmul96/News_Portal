            ...
            <div class="row">
              ...
              <div class="col-md-12">
                ...
                <div class="card card-primary">
                  ...
                  <!-- /.card-header -->
                  <!-- form start -->
                  <form role="form"  action="{{route('post_store')}}" method="post"  enctype="multipart/form-data"> 
                    @csrf
                    <div class="card-body">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('title_bn') is-invalid @enderror" id="exampleInputEmail1"  name="title_bn" value="{{ old('title_bn') }}">
                      ...
                      <div class="form-group  col-md-6">
                        ...
                        <input type="text" class="form-control @error('title_en') is-invalid @enderror" id="exampleInputPassword1" name="title_en" value="{{old('title_en')}}">
                    ...
                    <div class="row">
                      <div class="form-group col-md-6">
                        ...
                        <input type="text" class="form-control @error('tags_bn') is-invalid @enderror" value="{{ old('tags_bn') }}" name="tags_bn" data-role="tagsinput">
                        @error('category_en')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                      ...
                      <div class="form-group  col-md-6">
                        ...
                        <input type="text" class="form-control  @error('tags_en') is-invalid @enderror" value="{{ old('tags_en') }}" name="tags_en" data-role="tagsinput">
                        @error('tags_en')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
                      ...
                      <div class="form-group  col-md-12">
                        ...
                        <textarea class="form-control textarea @error('details_en') is-invalid @enderror" name="details_en" value="{{ old('details_en') }}"></textarea>
                        @error('details_en')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <textarea class="form-control textarea @error('details_bn') is-invalid @enderror" name="details_bn" name="details_bn" value="{{ old('details_bn') }}"></textarea>
