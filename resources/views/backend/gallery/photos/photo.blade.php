          ...
          <table id="example1" class="table table-bordered table-striped">
           ...
           @foreach($photo as $key=>$row)
            <tr>
              ...
              <td>
                    <a href="{{route('photo_edit',$row->id)}}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
                    <a href="{{route('photo_delete',$row->id)}}" class="btn btn-danger" id="delete"> <i class="fa fa-trash"></i> </a>
              </td>
            </tr>
            @endforeach
          </tbody>
